...
function NewEvent() {
  ...
  const handleClick = () => {
    quantity < 100 ? `Added item: ${name}, quantity: ${quantity}, category: ${category}` : console.log("Quantity must be less than 100");
  };
    ...
    <main>
      <div className="flex items-center justify-center">
        <div className="w-full max-w-md bg-white mt-5 p-8 rounded-lg shadow-lg">
          <h1 className="text-2xl text-gray-800 font-bold mb-4">Create New Item</h1>
          <form onSubmit={handleSubmit}>
            ...
            <label className="inline-block">
              <span className="ml-0 mr-1 rounded-md text-gray-800 ">Category:</span>
              <select
